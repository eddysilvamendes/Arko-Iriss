...
if (!$errors && !$missing) {
    ...
    $replacements = [
        'gambodjeu.aparthotel@gmail.com'  =>
            ['#subject#' => 'Pedido de Reserva Aparthotel Gambodjeu'],
        $email  =>
            ['#subject#' => 'Pedido de Reserva Aparthotel Gambodjeu']
   ];
    ...
    try {
       ...
       $message = Swift_Message::newInstance()
            ...
            $image_ilha = $message->embed(Swift_Image::fromPath('images/santiago.png'));
...
<title>Aparthotel Gambodjeu </title>
</head>
...
center">Pedido de Reserva Aparthotel Gambodjeu</h1>
</td>
</tr>
<tr>
